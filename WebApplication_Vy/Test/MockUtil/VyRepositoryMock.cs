...
namespace Test.MockUtil
{
    public static class VyRepositoryMock
    {
        ...
        {
            new Customer{Id = 1, Address = "Adress1", Email = "1@email.com", Givenname = "Given1", Surname = "Sur1", Tickets = Tickets, Zipcode = Zipcode}, 
            new Customer{Id = 2, Address = "Adress2", Email = "2@email.com", Givenname = "Given2", Surname = "Sur2", Tickets = Tickets, Zipcode = Zipcode},
            new Customer{Id = 3, Address = "Adress3", Email = "3@email.com", Givenname = "Given3", Surname = "Sur3", Tickets = Tickets, Zipcode = Zipcode},
        };
